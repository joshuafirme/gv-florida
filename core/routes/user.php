...
Route::
        namespace('User\Auth')->middleware('guest')->name('user.')->group(function () {
            ...
            Route::controller('SocialiteController')->group(function () {
                ...
                Route::match(['get', 'post'], 'social-login/callback/{provider}', 'callback')->name('social.login.callback');
            });
        });
...
Route::name('user.')->group(function () {
    ...
    Route::post('paynamics/status', 'Gateway\Paynamics\ProcessController@status')->name('paynamics.status');
});
...
Route::post('payment/release-seats', 'Gateway\PaymentController@releaseSeats')->name('user.deposit.release-seats');
